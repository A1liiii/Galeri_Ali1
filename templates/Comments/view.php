...
<div class="view card card-primary card-outline">
    ...
    <div class="card-body table-responsive p-0">
        <table class="table table-hover text-nowrap">
            ...
            <tr>
                <th><?= __('Gallery') ?></th>
                <td><?= $comment->has('gallery') ? $this->Html->link($comment->gallery->title, ['controller' => 'Galleries', 'action' => 'view', $comment->gallery->id]) : '' ?></td>
            </tr>
            <tr>
                <th><?= __('Id') ?></th>
...
<div class="view text card">
    <div class="card-header">
        <h3 class="card-title"><?= __('Comment Content') ?></h3>
    </div>
    <div class="card-body">
